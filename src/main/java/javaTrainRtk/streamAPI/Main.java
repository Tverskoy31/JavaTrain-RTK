...
public class Main {
        public static void main(String[] args) {
            ...
            // Путь к файлу внутри каталога cars
            String fileName = "src/main/java/javaTrainRtk/streamAPI/data/cars.txt";

            // Сохраняем в файл
            repo.saveToFile(fileName, cars);

            // Загружаем обратно из файла
            List<Car> carsFromFile = repo.loadFromFile(fileName);
